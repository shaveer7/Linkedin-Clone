...
function Header() {
  return (
    ...
    <div className="flex items-center justify-between container mx-auto ">
        ...
        <img src={"/linkedin.png"} className="h-9 rounded-sm" alt="LinkedIn" />
        <div className="ml-1 transition-all duration-300 ease-in-out w-74 focus-within:w-94 flex items-center bg-white border border-gray-400 rounded-3xl px-4">
      ...
      <div className="flex items-center col-span-7">
        ...
        <div className="flex flex-col items-center justify-center">
          <GridDotsIcon />
          <div className="flex items-center justify-center">
            <div className="text-xs">For Business</div>
            <DropDownIcon />
          </div>
        </div>
        <div className="flex flex-col items-center justify-center">
          <img src="/premium.png" alt="" className="h-5 w-fit" />
          <div className="text-xs">Try Premium for PKR0</div>
        </div>
      </div>
    </div>
    </div>
